...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    private final ApplicationUserRepository mApplicationUserRepository;

    @Autowired
    public CustomUserDetailsService(ApplicationUserRepository applicationUserRepository) {
        this.mApplicationUserRepository = applicationUserRepository;
    }

    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ApplicationUser applicationUser = loadApplicationUserNameByUsername(username);
        return new CustomUserDetails(applicationUser);
    }

    public ApplicationUser loadApplicationUserNameByUsername(String username) {
        return Optional.ofNullable(mApplicationUserRepository.findByUsername(username))
