...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationToken(HttpServletRequest request) {
        ...
        UserDetails userDetails = mCustomUserDetailsService.loadUserByUsername(username);
        ApplicationUser applicationUser = mCustomUserDetailsService.loadApplicationUserNameByUsername(username);
